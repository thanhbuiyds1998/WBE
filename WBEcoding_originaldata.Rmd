...
WBE= WBE%>%
  mutate(Weekday= wday(Date,label=T,abbr = T),
         ...
         NICabs_COT= COTmassavg*3.04,
         Tobacco_COT = NICabs_COT/(0.172*0.9*0.66*R15),
         Acesulfame = 1*(ACE1*80000 + ACE2*85000)/(400000+430000),
         Paracetamol = 2*(PARA1*80000 + PARA2*85000)/(400000+430000))
table1(~COTmassavg15+ACEmassavg+PARAmassavg+ NICabs_COT|Period, data= WBE)
```
